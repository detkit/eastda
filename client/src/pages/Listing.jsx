		...
		<main>
			...
			{listing && !loading && !error && (
				<div>
					...
					<div className='fixed top-[13%] right-[3%] z-10 border rounded-full w-12 h-12 flex justify-center bg-slate-100 items-center cursor-pointer'>
						<FaShare
					...
					<div className='flex flex-col max-w-4xl gap-4 p-3 mx-auto my-7'>
						...
						<p className='flex items-center gap-2 my-2 mt-6 text-sm text-slate-600'>
						...
						<ul className='flex flex-wrap items-center gap-6 text-sm font-semibold text-green-900'>
